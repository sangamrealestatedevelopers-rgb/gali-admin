				...
				<div class="row">
					<div class="col-md-4">
						<div class="footer_link">
							<h4></h4>
							<img src="{{URL::asset('front')}}/assets/images/KGF.png" width="100px">
							<p>
					...
					<div class="col-md-3">
						<div class="footer_link">
							<h4>Reach Us</h4>
							<ul>
								<li><a href="tel:+91 {{ data_get($select, 'whatsapp', '') }}">Phone: Call: +91 12345 67890</a></li>
       	...
       	<div class="login-signup">
              ...
              <div class="row">
                 <div class="col-md-6 pr-md-0">
                    <img src="{{URL::asset('front')}}/assets/images/product1.jpg" class="login-baner img-fluid">
                 </div>
