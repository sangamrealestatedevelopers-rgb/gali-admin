                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <img src="{{ url('backend/uploads/Payment_qrcode/' . rawurlencode((string) $select->image)) }}?v={{ optional($select->updated_at)->timestamp ?? time() }}" height="100px" width="100px" class="img-responvice">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
