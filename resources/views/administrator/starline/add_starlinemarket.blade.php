            ...
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-wrap">
                                {{ Form::open(array('url' => route('store_starline_gamemarket'), 'data-toggle'=>'validator' , 'class'=> 'form-horizontal', 'enctype'=>'multipart/form-data')) }}
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                       <input type="time"class="form-control" name="market_name" placeholder="Market Name" required >
                                                        @error('market_name')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="radio radio-danger">
                                                            <input type="radio" name="is_holiday" id="radio16" value="0">
											...
											<div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="radio radio-danger">
                                                            <input type="radio" name="market_sunday_off" id="radio16" value="N">
                                                            <label for="radio16"> NO </label>
                                                        </div>
                                                    </div>
                                                </div>
											...
											<div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="is_time_limit_applied" id="radio14" value="1">
                                                            <label for="radio14"> YES </label>
                                                        </div>
                                                        <div class="radio radio-danger">
											...
											<div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="is_no_limit_game" id="radio14" value="1">
                                                            <label for="radio14"> YES </label>
                                                        </div>
                                                        <div class="radio radio-danger">
											...
											<div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="radio radio-danger">
                                                            <input type="radio" name="market_saturday_off" id="radio16" value="N">
                                                            <label for="radio16"> NO </label>
                                                        </div>
                                                    </div>
                                                </div>
											...
											<div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="radio radio-danger">
                                                            <input type="radio" name="close_by_admin" id="radio16" value="N">
                                                            <label for="radio16"> NO </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="status" id="radio14" value="1">
