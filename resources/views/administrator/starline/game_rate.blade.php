                            ...
                            <div class="table-wrap mt-40">
                                <form>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="number" class="form-control" id="inputEmail4" value="{{$strgamerate->single_digit_value1}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="inputPassword4" class="form-label">Single Digit Value 2</label>
                                        <input type="number" class="form-control" id="inputPassword4" value="{{$strgamerate->single_digit_value2}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="inputEmail4" class="form-label">Jodi Digit Value 1</label>
                                        <input type="number" class="form-control" id="inputEmail4" value="{{$strgamerate->jodi_digit_value1}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="inputPassword4" class="form-label">Jodi Digit Value 2</label>
                                        <input type="number" class="form-control" id="inputPassword4" value="{{$strgamerate->jodi_digit_value2}}">
                                    </div>
                                    
                                    <div class="col-md-6 form-group">
                                        <label for="inputCity" class="form-label">Single Pana Value 1</label>
                                        <input type="number" class="form-control" id="inputCity" value="{{$strgamerate->single_pana_value1}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="inputCity" class="form-label">Single Pana Value 2</label>
                                        <input type="number" class="form-control" id="inputCity" value="{{$strgamerate->single_pana_value2}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="inputEmail4" class="form-label">Double Pana Value 1</label>
                                        <input type="number" class="form-control" id="inputEmail4" value="{{$strgamerate->double_pana_value1}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="inputPassword4" class="form-label">Doublele Pana Value 2</label>
                                        <input type="number" class="form-control" id="inputPassword4" value="{{$strgamerate->double_pana_value2}}" >
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="inputEmail4" class="form-label">Triple Pana Value 1</label>
                                        <input type="number" class="form-control" id="inputEmail4" value="{{$strgamerate->triple_pana_value1}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="inputPassword4" class="form-label">Triple Pana Value 2</label>
                                        <input type="number" class="form-control" id="inputPassword4" value="{{$strgamerate->triple_pana_value2}}">
                                    </div>
                                    
                                    <div class="col-md-6 form-group">
                                        <label for="inputCity" class="form-label">Half Sangam Value 1</label>
                                        <input type="number" class="form-control" id="inputCity"  value="{{$strgamerate->Half_Sangam_Value1}}">
                                    </div>
                                    <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="number" class="form-control" id="inputCity" value="{{$strgamerate->Half_Sangam_Value2}}">
                                    </div>
                                    <div class="col-md-6 form-group">
