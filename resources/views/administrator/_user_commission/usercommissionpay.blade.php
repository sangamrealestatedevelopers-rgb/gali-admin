                                        ...
                                        <tr>
                                            <th>
                                                <div class="form-group ">
                                                    ...
                                                    <input type="date" class="form-control" name="date" id="date" required value="<?= @$_GET['date'] ?>">
                                                </div>
                                            ...
                                            <th>
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="market" id="mobile" required value="<?= @$_GET['mobile'] ?>">
                                                </div>
                                            </th>
                                            <th>
                                                <form>
