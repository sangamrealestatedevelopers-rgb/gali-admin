        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                   <a href="{{URL::to('administrator/gali-disawar-game-name-list')}}" class="btn btn-danger">Go Back</a>
                </div>
            </div>
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                       <input type="text"class="form-control" name="market_name" placeholder="Market Name" value="{{$select->market_name}}" required >
                                                        @error('market_name')
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                       <input type="time"class="form-control" name="market_view_time_close"   placeholder="Close Time" value="{{ old('market_view_time_close', $select->market_view_time_close ?? '') }}">
                                            ...
                                            <div class="col-md-9">
											 ...
											 <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control" name="market_position" placeholder="Market Position" value="{{$select->market_position}}" required>
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="status" id="radio14" value="1" @if((int)($select->status ?? 0) === 1) checked @endif>
                                                            <label for="radio14"> Enable </label>
                                                        </div>
                                                        <div class="radio radio-danger">
                                                            <input type="radio" name="status" id="radio16" value="0" @if((int)($select->status ?? 0) === 0) checked @endif>
