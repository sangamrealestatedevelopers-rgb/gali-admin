                            ...
                            <form method="get">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                        <input type="date" name="deposit_date" id="deposit_date" value="{{$date}}" class="form-control" placeholder="Select Date" required>
                                    ...
                                    <div class="col-md-3">
                                        <a href="{{URL::to('/administrator/game/deposit-dateway-pending-old')}}" class="btn btn-success" >Refresh</a>
                                    </div>
                                </div>
                            {{ Form::close() }}
                        </div> 
...
@endsection
@push('scripts')
<script src="{{asset('/backend/developer/js/DepositManagementOld.js')}}"></script>
<script>
