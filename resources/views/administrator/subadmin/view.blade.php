            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="text-right"><a href="{{route('admin_subadmins')}}" class="btn btn-info">Back</a>
                            
                        </div>
                        <div class="form-body">
                                        <hr class="light-grey-hr"/>
                                        <div class="row">
                                            <input type="hidden" name="ad_id" value="{{$users->ad_id}}">
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    <label class="control-label col-md-4"> UserName<span class="text-danger">*</span></label>
                                                    <div class="col-md-7">
                                                       <input disabled type="text"class="form-control" name="userid" value="{{$users->userid}}" id="userid" placeholder=" Userrname">
                                                        @error('userid')
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input disabled type="email" class="form-control" name="email"  id="email" placeholder="Email" value="{{$users->email}}">
                                                        @error('email')
                                                            <div class="alert alert-danger alert-dismissable alert-style-1">
                                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                                <i class="zmdi zmdi-block"></i>{{ $message }}
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    <label disabled class="control-label col-md-4">Mobile<span class="text-danger">*</span></label>
                                                    <div class="col-md-7">
                                                       <input disabled type="text"class="form-control" name="mobile" value="{{$users->mobile}}" id="mobile" placeholder="mobile">
                                                        @error('mobile')
                                                            <div class="alert alert-danger alert-dismissable alert-style-1">
                                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                                <i class="zmdi zmdi-block"></i>{{ $message }}
                                            ...
                                            <!-- <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="password" class="form-control" name="password" value="{{$users->password}}" placeholder="Password"  required>
                                                        @error('password')
                                                            <div class="alert alert-danger alert-dismissable alert-style-1">
                                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                                <i class="zmdi zmdi-block"></i>{{ $message }}
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="password" class="form-control" name="password_confirmation" value="{{$users->password_confirmation}}" placeholder="Confirm Password" required>
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <?PHP $permission= explode(",",$users->role_id); ?>
                                                        
                                                        <div class="col-md-6">
                                                            <div class="permission-item">
                                                                <input disabled type="checkbox" name="permission[]"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="permission-item">
                                                                <input disabled type="checkbox" name="permission[]" value="users"
