...
if($type == '2'){
$msg1=$user;	
$chk_user=mysqli_query($conn, "SELECT * FROM us_reg_tbl WHERE mob ='".$userMob."' AND  user_status = '1'");
...
if($count_chk_user > 0){
 ...
 $sqlupdtpss = "UPDATE `us_reg_tbl` SET `us_pass` = '".$pass_new."' WHERE mob ='".$userMob."' AND user_status = '1'";
 ...
 exit;
	     ...
	     $rows['success'] = '3';
		 $rows['message'] = "Device does not exists or blocked."; 
		 echo (json_encode($rows));
		 exit; 
