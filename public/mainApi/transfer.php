...
if ($userid == '' ||  $rec_mob == '' || $devName == '') {
	...
	if ($rcheck) {
		...
		if ($amount >= $comm['transfer_min'] and $amount <= $comm['transfer_max']) {
	       ...
	       VALUES ('$order_id','Transfer','1','Credit','$rec_id','$userid','$appId','TRDEPO002', '$amount','$newcoins','$date', '$date_time', 'Success','From-$smob')";
	       ...
	       VALUES ('$order_id','Transfer','1','Debit','$userid','$rec_id','$appId','TRWITH003', '$amount','$new','$date', '$date_time', 'Success','To-$rec_mob') ";
