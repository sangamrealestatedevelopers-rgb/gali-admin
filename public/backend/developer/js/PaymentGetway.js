...
dataTable = $('#paymentgetway_list').DataTable({
    responsive: true,
    serverSide: true,
    "oLanguage": {
    ...
    "ajax": {
        ...
        url: BASE_URL + '/administrator/get-payment-getway-data',
        type: "post",
        error: function() {
            $(".user-table-error").html("");
            $("#paymentgetway_list").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
        }
    },
