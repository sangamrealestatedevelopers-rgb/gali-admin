...
dataTable190 = $('#deposit_pending').DataTable({
    ...
    "ajax": {
        ...
        url: BASE_URL + '/administrator/get-deposit-data-pending',
        type: "post",
        error: function () {
...
var img = "{{url('/public/front/images/loading.gif')}}";
// alert('hello');
dataTable191111 = $('#deposit_success').DataTable({
    ...
    "ajax": {
        ...
        url: BASE_URL + '/administrator/get-deposit-data-success',
        type: "post",
        error: function () {
            $(".user-table-error").html("");
...
dataTable180 = $('#date_withdraw_pending').DataTable({
    ...
    "ajax": {
        ...
        url: BASE_URL + '/administrator/get-datedeposit-data',
        type: "post",
        error: function () {
            $(".user-table-error").html("");
            $("#deposit_success").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
...
dataTable18 = $('#deposit_cancelled').DataTable({
    ...
    "ajax": {
        ...
        url: BASE_URL + '/administrator/get-deposit-data-cancelled',
        type: "post",
        error: function () {
            $(".user-table-error").html("");
