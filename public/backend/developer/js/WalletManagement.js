...
dataTable = $('#fund_request').DataTable({
    responsive: true,
    serverSide: true,
    "oLanguage": {
    ...
    "ajax": {
        ...
        url: BASE_URL + '/administrator/get-fund-request-data',
        type: "post",
        error: function() {
            $(".user-table-error").html("");
            $("#fund_request").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
        }
    },
