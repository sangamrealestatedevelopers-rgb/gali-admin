...
dataTable = $('#datacatr').DataTable({
    ...
    "ajax": {
        ...
        url: BASE_URL + '/administrator/winning-prediction-data',
        type: "post",
        error: function() {
            $(".user-table-error").html("");
            $("#datacatr").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
        }
    },
