...
$sql = "INSERT INTO `us_reg_tbl`(`mob`, `us_pass`,`app_id`,`FullName`,`ref_code`, `ref_by`, `lat`, `lng`, `dev_model`,`dev_name`, `device_id`, `dob`,`us_gender`,`credit`,`bonus_diamonds`, `user_id`) 
VALUES ('$mobileNum', '$pss','$appId','$fullName','$referral', '$refercode', '$lat', '$lng', '$address', '$devModel', '$devName', '$devId','$gender','00','0','$tr_id')";
