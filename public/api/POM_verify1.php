...
$length = 10;
$paymentRequestId = substr(str_shuffle('ABCDEFGHIJKLMNOPQRSTUVWXYZ'), 1, $length);
$date = date("d-m-Y", $timestamp);
...
$insertData1 = "INSERT INTO `point_table`( `app_id`, `user_id`,`paymentRequestId`, `tr_nature`,  `tr_value`, `tr_value_updated`, `value_update_by`, `tr_value_type`, `tr_device`, `date`, `date_time`, `tr_remark`, `tr_status`, `is_deleted`, `device_type`, `device_id`, `admin_key`,`created_at`) VALUES ('com.dubaiking','$userid','$paymentRequestId','TRDEPO002','$orderamount','$newcoins','Deposit','Credit','com.dubaiking','$date','$date_time','Online','Pending','0',' ','','ADMIN0001','$created_at')";
