...
<?php $__env->startSection('content'); ?>
    <section>
        ...
        $date = date('Y-m-d');
                                            ...
                                            ?>
                                            <input type="date" name="market_date" id="market_date" value="<?php echo e($date); ?>"
                ...
                if (selectedIds.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "<?php echo e(route('bets.delete')); ?>",
                                type: 'POST',
                                data: {
                                    bet_ids: selectedIds,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('administrator.layout.administrator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dubaiking/public_html/Admin/resources/views/administrator/galidisawar/bid_history.blade.php ENDPATH**/ ?>