				...
				<div class="card bg-pink">
					<div class="card-body">
						<div class="d-flex justify-content-between card_flex_custum">
							<a href="">
								<div class=" pl-0 pr-0 data-wrap-left">
									<span class="weight-500 uppercase-font txt-light block font-16">Withdraw
										Money</span>
									<span class="txt-light block counter"><span class="counter-anim"><?php echo e($withdraw_money); ?></span></span>
								</div>
								<div class="  pl-0 pr-0 data-wrap-right font-size-30">
									<i class="fa fa-users txt-light data-right-rep-icon"></i>
								</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('administrator.layout.administrator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dubaimatka/public_html/Admin/resources/views/administrator/dashboard/index.blade.php ENDPATH**/ ?>