                        ...
                        <div class="col-md-12">
                            <div class="form-wrap">
                               <?php echo e(Form::open(array('url' => 'administrator/edit-store-gd-game'))); ?>
                                ...
                                <input type="hidden" name="markets_id" value="<?php echo e($select->id ?? $select->_id); ?>">
                                <input type="hidden" name="mongo_id" value="<?php echo e($select->_id); ?>">
...
unset($__errorArgs, $__bag); ?>
											 ...
											 <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control" name="market_position" placeholder="Market Position" value="<?php echo e($select->market_position); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="radio radio-success">
                                                            <input type="radio" name="status" id="radio14" value="1" <?php if((int)($select->status ?? 0) === 1): ?> checked <?php endif; ?>>
                                                            <label for="radio14"> Enable </label>
                                                        </div>
                                                        <div class="radio radio-danger">
                                                            <input type="radio" name="status" id="radio16" value="0" <?php if((int)($select->status ?? 0) === 0): ?> checked <?php endif; ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('administrator.layout.administrator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgood/public_html/admin/resources/views/administrator/galidisawar/edit_Gdgame.blade.php ENDPATH**/ ?>