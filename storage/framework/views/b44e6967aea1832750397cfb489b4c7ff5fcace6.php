            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button type="button" onclick="get_data11()" class="btn btn-success mob_bottom2">Search</button>
                        </div>
...
<?php echo $__env->make('administrator.layout.administrator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin.playonlineds.net/public_html/resources/views/administrator/deposit_management/pending.blade.php ENDPATH**/ ?>