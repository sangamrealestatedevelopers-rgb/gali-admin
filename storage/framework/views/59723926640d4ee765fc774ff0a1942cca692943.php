                        ...
                        <div class="panel-body">
                            <div class="table-wrap mt-40">
                                <!-- <form> -->
                                    ...
                                    <input type="hidden" class="form-control" name="id" id="id" value="<?php echo e($apkManager->_id); ?>">
...
<?php echo $__env->make('administrator.layout.administrator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin.playonlineds.net/public_html/resources/views/administrator/web_setting/apk_manager.blade.php ENDPATH**/ ?>