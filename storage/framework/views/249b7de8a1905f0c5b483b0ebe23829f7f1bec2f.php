    ...
    <!--changes end -->
        ...
        <li>
            ...
            <ul id="noticem" class=" collapse-level-1  collapse <?PHP if (in_array($url, $noticeManagement)) { echo "in"; } ?>">
                <li>
                    <a href="<?php echo e(route('notice_list')); ?>">Notice List</a>
                </li>
                <li>
                    <a href="<?php echo e(route('add_notice')); ?>">Notice Add</a>
                </li>
...
</div><?php /**PATH /home/dubaimatka/public_html/Admin/resources/views/administrator/includes/left_sidebar.blade.php ENDPATH**/ ?>