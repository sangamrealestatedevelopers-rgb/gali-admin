                    ...
                    <div class="col-md-3">
                        <select class="form-control" name="select_market" id="select_market" required>
                            ...
                            <?php $__currentLoopData = $market_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e((string) $item->getKey()); ?>" <?php    if ((string) $item->getKey() === (string) trim($select_market)) {
                                    echo "selected";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('administrator.layout.administrator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgood/public_html/admin/resources/views/administrator/managemarket/winner_number.blade.php ENDPATH**/ ?>