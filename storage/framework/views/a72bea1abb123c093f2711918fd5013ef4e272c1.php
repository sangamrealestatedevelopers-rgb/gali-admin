        ...
        <form id="payment" method="post" action="<?php echo e(URL::to('user/upload-reciept')); ?>" enctype="multipart/form-data">
          ...
          <div class="upi-payment-step">
            ...
            <div class="mb-3 text-center">
                ...
                <input class="form-control w-50 mx-auto" type="file" id="upi-input" name="image" required>
            </div>
...
</script><?php /**PATH /home/dubaimatka/public_html/Admin/resources/views/front/page/manual_gateway.blade.php ENDPATH**/ ?>