        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    ...
                    <a href="<?php echo e(URL::to('administrator/gali-disawar-game-name-list')); ?>" class="btn btn-danger">Go
                        Back</a>
                </div>
            </div>
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                    <!-- <?php echo e(Form::open(array('url' => 'administrator/result-gd-game-declear'))); ?> -->
                        ...
                        <div class="col-md-12">
                            <div class="form-wrap">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <input type="text" name="id" id="id" value="<?php echo e($id); ?>" style="display:none;">
                                        <div class="col-md-9">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('administrator.layout.administrator', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dubaiking/public_html/Admin/resources/views/administrator/galidisawar/result_close.blade.php ENDPATH**/ ?>