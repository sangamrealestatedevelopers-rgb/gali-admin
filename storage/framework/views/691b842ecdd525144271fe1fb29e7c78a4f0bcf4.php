...
<body>
  <div class="container text-center">
    ...
    <div class="qr-section">
      ...
      <div class="qr-image">
        <img src="<?php echo e(URL::asset('/backend/uploads/Payment_qrcode/' . rawurlencode($qr_code->image))); ?>?v=<?php echo e(optional($qr_code->updated_at)->timestamp ?? time()); ?>" alt="QR Code">
        <h4 class="mt-2">Amount : <?php echo $amount; ?> </h4>
      </div>

      <div class="helpline mt-4">
        Helpline Number - <span class="helpline-number">+91 <?php echo e(optional($upi)->help_line_number); ?></span>
      </div>
  ...
  <div class="container">
    <div class="row text-center">
      ...
      <div class="col-md-12">
        ...
        <div class="image_qr">
          <img src="<?php echo e(URL::asset('/backend/uploads/Payment_qrcode/' . rawurlencode($qr_code->image))); ?>?v=<?php echo e(optional($qr_code->updated_at)->timestamp ?? time()); ?>">
        </div>
...
<?php /**PATH /home/xgood/public_html/admin/resources/views/front/page/payment_by_scanner.blade.php ENDPATH**/ ?>